...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.public_upload.driver' => 'string',
            'filesystems.disks.public_upload.root' => 'string',
            'filesystems.links.C:\laragon\www\proyectoTest\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.public_upload.driver','filesystems.disks.public_upload.root',
'filesystems.links.C:\\laragon\\www\\proyectoTest\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'sanctum.csrf-cookie','category.index','category.store','category.show',
'category.update','category.destroy','post.index','post.store','post.show',
'post.update','post.destroy','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','blog.index','blog.layout','blog.show','components.application-logo',
'components.auth-session-status','components.blog.post.index','components.danger-button','components.dropdown','components.dropdown-link',
'components.input-error','components.input-label','components.modal','components.nav-link','components.primary-button',
'components.responsive-nav-link','components.secondary-button','components.text-input','dashboard','dashboard.category._form',
'dashboard.category.create','dashboard.category.edit','dashboard.category.index','dashboard.category.show','dashboard.fragments._errors-form',
'dashboard.layout','dashboard.post._form','dashboard.post.create','dashboard.post.edit','dashboard.post.index',
'dashboard.post.show','layouts.app','layouts.guest','layouts.navigation','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','vue','welcome',
